...
export type Source = { type:string; title:string; id:number; snippet:string; document_title?:string | null; status?:string | null; version?:string | null; owner?:string | null; last_verified_date?:string | null; href?:string | null; download_url?:string | null; filename?:string | null };
